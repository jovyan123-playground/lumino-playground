...
def build_examples(out_dir):
    ...
    targets = ["accordionpanel", "datagrid", "dockpanel"]
    examples_dir = osp.join(root, "examples")
    api_index = osp.join(examples_dir, f"example-{targets[0]}", "index.html")
    ...
    for target in targets:
        source = osp.join(root, "examples", f"example-{target}")
        dest_dir = osp.join(out_dir, "examples", target)
